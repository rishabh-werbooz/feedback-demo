...
export const fetchRoadMaps = async ({ organizationId, websiteId }: { organizationId: string, websiteId: string }) => {
    ...
    const url = serverUrl + `/feedback/issues/roadmaps?id=${organizationId}&website_id=${websiteId}`
